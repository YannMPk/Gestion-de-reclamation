			...
			<div class="sidebar-brand">
				<div class="brand-flex">
					...
					<?php 
					 ...
					 ?>
						<span style="width: 12x;"><?= "Admin-ID : ".$idClt ?> tt</span>
					<?php endif; ?>
				</div>
			</div>
							...
							<ul>
								<li>
									<a href="all-claim-list.php">
										<i class="fas fa-file-alt"></i> voir les traitements effectués
									</a>
								</li>
								<li>
									<a href="all-claim-list.php">
										<i class="fas fa-pen"></i>Informer un client
									</a>
								</li>
								<li>
									<a href="all-claim-list.php">
										<i class="fas fa-pen"></i>Informer un service de traitement
									</a>
								</li>
							</ul>
						</div>
